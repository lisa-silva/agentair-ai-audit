...
BUSINESS_TYPES = {
    ...
    "SaaS": "SoftwareApplication", # Added SaaS mapping here
...
{schema_json}
        ...
        # Validation link completed here
        st.markdown("[Test this schema in the Schema Validator](https://validator.schema.org/)")
